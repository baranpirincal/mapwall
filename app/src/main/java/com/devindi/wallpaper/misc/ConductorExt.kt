 ...
 * @param parameters - parameters to pass to the BeanDefinition
 */
inline fun <reified T : ViewModel> FixedLifecycleController.viewModel(
        key: String? = null,
        name: String? = null,
        noinline parameters: Parameters = { emptyMap() }
): Lazy<T> {
 ...
 * @param parameters - parameters to pass to the BeanDefinition
 */
fun <T : ViewModel> FixedLifecycleController.viewModelByClass(
        clazz: KClass<T>,
        key: String? = null,
        name: String? = null,
        parameters: Parameters = { emptyMap() }
 ...
 * @param parameters - parameters to pass to the BeanDefinition
 */
fun <T : ViewModel> FixedLifecycleController.getViewModelByClass(
        clazz: KClass<T>,
        key: String? = null,
        name: String? = null,
        parameters: Parameters = { emptyMap() }
